        ...
        while True:
            ...
            for message in messages:
                ...
                try:
                    ...
                    print(
                        f"Locked Until: "
                        f"{message.locked_until_utc}"
                    )
                    
                    print(
                        f"Delivery Count: "
                        f"{message.delivery_count}"
                    )

                    process_message(message)

                    print(
                        f"Completing message: {message.message_id}"
                    )
                    ...
                    try:
                        ...
                        print(
                            f"Completed message: {message.message_id}"
                        )

                    except Exception as complete_ex:
                        print(
                            f"Complete Failed: "
                            f"{type(complete_ex).__name__}"
                        )      
                        print(
                            f"ERROR: {complete_ex}"
                        )
